...
<p align="center">
  <picture>
    <source media="(max-width: 760px) and (prefers-color-scheme: dark)" srcset="./assets/hero/agent-console-2f286dd3-mobile-dark.svg">
    <source media="(max-width: 760px)" srcset="./assets/hero/agent-console-2f286dd3-mobile-light.svg">
    <source media="(prefers-color-scheme: dark)" srcset="./assets/hero/agent-console-2f286dd3-dark.svg">
    <source media="(prefers-color-scheme: light)" srcset="./assets/hero/agent-console-2f286dd3-light.svg">
    <img src="./assets/hero/agent-console-2f286dd3-dark.svg" alt="Akram Junaidi - Student & Tech Enthusiast" width="100%">
  </picture>
</p>
